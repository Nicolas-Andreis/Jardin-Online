    ...
    return (
        <div className='container-ubicación'>
            <div className='card-ubicación'>
                ...
                ></iframe>
                <div className='text-ubicación'>
                    <h3 className='poppins'>Ubicación</h3>
                    <p className='poppins'>¡Despierta tu espacio con la frescura de la naturaleza! Visita Jardín Online para encontrar las plantas perfectas que transformarán tu hogar.</p>
                    <p className='poppins'>Direccion: vieytes 719 <br />
